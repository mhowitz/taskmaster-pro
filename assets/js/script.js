...
$(".list-group").on("change", "input[type='text']", function (){
  ...
  var index = $(this)
    .closest(".list-group-item")
    .index();
  //get the task in array and re-save to local storage
...
$(".card .list-group").sortable({
  ...
  update: function(event) {
    ...
    //mking the trash shit droppable
    $("#trash").droppable({
    ...
    //update array on tasks object and savve
...
var auditTask = function(taskEl) {
  ...
  //this should print out an object for the value of the date variabble, but at 5pm of that date
  console.log(time);
